...
function OnChangeSelect(fieldName){
    ...
    if (selectValue == "Sankey") {
        ...
        hebUIBox.html('<span> From (year-month) </span>' +
                      ...
                      '<label for="strengthSlider"> Bundle strength </label>'  + '<select id="edgeColor" name="edgeColor"><option value="fromto">From-to</option><option value="sentiment">Sentiment</option></select>'
                     );
    }
